                                    ...
                                    <div class="sbox-content">
                                        ...
                                        <div id="staff-utilization-updated" class="m-t-md">
                                            <small class="pull-right">
                                                ...
                                                Updated on <?php echo date('m-d-Y h:i A'); ?>
                                            </small>
                                            <!--here-->
                                        </div>
                                    </div><!-- /sbox-content -->
                            ...
                            <div class="col-lg-12">
                                <div class="sbox">
                                    <div class="sbox-content">
                                        ...
                                        <div>
                                            <div id="Daily"  >
                                                <h4 class="m-b-xs">Daily Company Snapshots</h4>
                                                <div class="sbox-title">
                                                    Week:&nbsp;<select id="company-resource-utilization-select-week"><?php echo $current_week_options; ?></select>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="sbox-content" id="company-resource-utilization-table" style="display:none; min-width: 310px; height: auto; max-width: 600px; margin: 0 auto">
                                        <table style="width:100%">
                                            ...
                                            foreach ($groups as $grp) {
                                                ...
                                                echo( "<tr><td style='color:".$grp->color."'><strong>".$grp->group."</strong></td><td align='center'>".number_format($hpw,2)."%</td><td align='center'>".$grp->hours_per_week."</td></tr>" );
                                            }
                                            ?>
                                        </table>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="sbox">
                                     ...
                                     <div class="sbox-content" id="project-percentages" style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto">
                            ...
                            <div class="col-lg-4">
                                <div class="sbox">
                                    <!--
                                     ...
                                     <div class="sbox-content" id="resource-type-percentages" style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto">
        ...
        $('#company-resource-utilization').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    foreach ($groups as $grp) {
                        $hpw = ($grp->hours_per_week/$grp->total_hours)*100;
                        echo( "{name: '".$grp->group."', y: ".$hpw.", x: ".$grp->hours_per_week.", color: '".$grp->color."'}, " );
                    }
                    ?>
                ]
            }]
