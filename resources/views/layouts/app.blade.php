...
<link rel="shortcut icon" href="{{ asset('favicon.ico')}}" type="image/x-icon">	
		...
		<link href="{{ asset('sximo/js/plugins/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
	    ...
	    <link href="{{ asset('dhtmlxScheduler/codebase/dhtmlxscheduler.css') }}" rel="stylesheet" type="text/css" media="screen" title="no title" charset="utf-8">
		<link href="{{ asset('sximo/js/plugins/fullcalendar/fullcalendar/fullcalendar.css') }}" rel="stylesheet">
		<link href="{{ asset('sximo/js/plugins/fullcalendar/fullcalendar/fullcalendar.print.css') }}" rel="stylesheet">


		<!--<link href="{{ asset('dhtmlxGrid/codebase/dhtmlxgrid.css') }}" rel="stylesheet">-->
	    ...
	    <script type="text/javascript" src="{{ asset('dhtmlxScheduler/codebase/dhtmlxscheduler.js') }}" charset="utf-8"></script>
	...
	<script src="/sximo/js/plugins/highcharts/highcharts.js"></script>
    <script src="/sximo/js/plugins/highcharts/exporting.js"></script>
	...
	<div id="wrapper">
		...
		<div class="footer fixed">
		    ...
		    <div>
		        <strong>Copyright</strong> &copy; 2016-{{ date('Y')}} . {{ CNF_COMNAME }}
		    </div>
		</div>		
